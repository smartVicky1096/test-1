...
public class Test_LoginActivity {

	@Test
	public void VijayaragavanLoginActivity() {
		...
		driver.findElement(By.xpath("//*[@id=\"navbarText\"]/ul[2]/span/span[4]/ul/li[2]/a")).click();
		WebElement LGA= driver.findElement(By.xpath("//*[@id=\"page-content-wrapper\"]/div/h5"));
		String headingString =LGA.getText();
		System.out.println("The text received is :"+headingString);
